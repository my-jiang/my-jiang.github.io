...
If a Markov process only has one class, then it is called **irreducible**
...
1.  All states in open class are transient
2.  If $$C$$ is **closed** and **has finite number of states**, then all states are **positive recurrent**
